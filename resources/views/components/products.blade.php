<div class="mt-12 w-7/12 mx-auto text-center border-2 rounded-2xl p-8">
    ...
    <div class="mt-4">
        <a href='https://github.com/ahmedshaheen201400721/Ecommerce-laravel' class="p-4 rounded-lg font-bold mr-2 bg-gradient-to-l from-blue-400 to-gray-500"> GitHub</a>
    </div>
</div>
        ...
        <div class="card1 rounded-lg overflow-hidden m-4 ">
            ...
            <div class="px-4 -mt-8 relative z-30 ">
                <div class=" p-2 bg-white space-y-2 shadow-lg bg-white rounded-lg">
                    ...
                    <p class="text-gray-600 truncate hover:whitespace-normal hover:overflow-ellipsis ">{{$product->description}}</p>
                    <div>
                        <a href="{{route('shop.product',$product->slug)}}" class="inline-block py-2 px-4 mt-4 rounded-full bg-blue-400 text-white capitalize font-bold hover:bg-blue-300"> Have a look </a>
                    </div>
                </div>
            </div>
